...
export default function App() {
  ...
  useEffect(() => {
    setShowInsight(false); setShowFullBody(false); setAttachmentPreviewId("");
    if (selected && window.innerWidth < 700) setMobileSidebarOpen(false);
  }, [selected?.id]);
  ...
  return (
    <div className="app" style={{ zoom: fontScale }}>
      {/* Sidebar */}
      <aside className={`sidebar ${mobileSidebarOpen ? "" : "collapsed"}`}>
        <div className="sidebar-header">
          <button className="mobile-menu-btn" onClick={() => setMobileSidebarOpen(p => !p)} title="Toggle sidebar">
          ...
          <div className="detail-view">
            <div className="detail-header">
              <div className="detail-header-top">
                <button className="mobile-back-btn" onClick={() => { setSelected(null); setMobileSidebarOpen(true); }}>
